<?php
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    public function execute()
    {
      ...
      static::removeMenu();
      static::removeProductsQuantityDiscountDb();
    ...
    private static function removeMenu()
    {
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code', 'app_catalog_quantity_discount');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_catalog_quantity_discount']);
      }
    }

    private static function removeProductsQuantityDiscountDb()
    {
      $CLICSHOPPING_Db = Registry::get('Db');
      ...
      if ($Qcheck->fetch() !== false) {
        $Qdelete = $CLICSHOPPING_Db->prepare('delete from :table_products_discount_quantity');
        $Qdelete->execute();
      }
    }
  }